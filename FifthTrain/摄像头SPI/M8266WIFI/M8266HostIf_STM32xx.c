...
void M8266HostIf_GPIO_CS_RESET_Init(void)
{
  ...
  M8266WIFI_nRESET_GPIO_RCC_CLOCK_EN;  															// enable nRESET GPIO clock
	GPIO_OUTPUT_HIGH(M8266WIFI_SPI_nCS_GPIO,M8266WIFI_SPI_nCS_PIN);		// nRESET output high initially	
...
///////////////  STM32F4  //////////////////////////////////////////////////////////
  ...
  SPI_InitTypeDef   SPI_InitStructure;
	...
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOB, ENABLE); 						// enable the SPI1 GPIO CLOCK
  ...
  GPIO_InitStructure.GPIO_PuPd 	= GPIO_PuPd_UP;
	...
	GPIO_PinAFConfig(GPIOB,GPIO_PinSource4,GPIO_AF_SPI1);							// Enable GPIO Alternate for SPI1
